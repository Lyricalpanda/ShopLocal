...
@interface SLBusinessViewController ()
{
    ...
    IBOutlet UIWebImageView *businessWebImageView;
...
- (void)viewDidLoad
{
    ...
    [businessWebImageView setUrl:[NSURL URLWithString:_business.url]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.itemImage setUrl:[NSURL URLWithString:currentItem.url]];
